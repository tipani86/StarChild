...
namespace Wechaty
{
    ...
    public class Wechaty : EventEmitter<Wechaty>, ISayable
    {
        ...
        public async Task<Message> Say(string id, string text)
        {
            await Puppet.MessageSendText(id, text);
            return null;
        }
        ...
        public async Task<Message> Say(string id,FileBox file)
        {
            await Puppet.MessageSendFile(id, file);
            return null;
        }

        public async Task<byte[]> GetFile(string id)
        {
            return await Puppet.MessageImageStream(id,ImageType.HD);
        }
        ...
        public Task<Message?> Say(string text, params Contact[]? replyTo) => throw new NotImplementedException();
